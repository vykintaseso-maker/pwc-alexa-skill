...
If you see `Missing Alexa Smart Home directive`, double-check that your test event follows the structure above and that your Lambda trigger is **Alexa Smart Home**.
