...
exports.handler = async (event, context) => {
  ...
  if (!namespace || !name) {
    throw new Error(
      'Directive header must include namespace and name. Use an Alexa Smart Home test event such as Discovery (Alexa.Discovery/Discover) or StateReport (Alexa/ReportState).'
    );
  }
  ...
  if (namespace === 'Alexa' && name === 'ReportState') {
    ...
    if (!endpointId) {
      throw new Error('ReportState directive missing endpointId.');
    }
